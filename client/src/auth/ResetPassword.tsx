    ...
    return (
        <div className="flex items-center justify-center w-screen h-screen ">
            <form className="md:border md:p-8 mx-4 md:border-gray-200 w-full max-w-md rounded-lg">
                ...
                <div className="mb-6 flex  flex-col gap-2 relative">
                    <Label htmlFor="password" className="pl-2 font-bold">New Password</Label>
                    <Input
                        value={password}
                        name="password"
                        className="pl-10 focus-visible:ring-0"
                ...
                <div className="mb-6 flex  flex-col gap-2 relative">
                    <Label htmlFor="password" className="pl-2 font-bold">Confirm New Password</Label>
                    <Input
                ...
                <div className="mb-6 flex justify-center items-center">
                    {
                        loading ? <Button disabled className="w-full bg-button hover:bg-hoverButtonColor"><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Please wait</Button> : (
                            <Button type="submit" className="w-full bg-button hover:bg-hoverButtonColor">Reset Password </Button>
                        )
                    }
                </div>
