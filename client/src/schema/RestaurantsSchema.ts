...
export const restaurantFormSchema = z.object({
    ...
    deliveryTime: z.coerce.number().min(1, { message: "Delivery time can not be negative" }),
    cuisines: z.array(z.string().nonempty({ message: "cuisines is required" })).nonempty({ message: "cuisines is required" }),
