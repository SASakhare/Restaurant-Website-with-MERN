...
const Restaurant = () => {
    ...
    const addrestaurantHandler = (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        console.log(input);
                        ...
                        <div className="w-full flex items-center justify-center">
                            {
                                loading ? (
                                    ...
                                    <Button type="submit" className=" w-full sm:w-1/2  md:w-1/3 bg-button hover:bg-hoverButtonColor">Add Restaurant</Button>
                                )
                            }
                        </div>
                    </form>
